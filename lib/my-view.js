...
export default class AwspilotLambdaUI {
	...
	constructor( serializedState, uri) {
		...
		var ractive = Ractive({
			...
			on: {
				'open-settings': function() {
					atom.workspace.open("atom://config/packages/amazon-lambda-ui")
				},
			}
		});
		...
		atom.config.observe('amazon-lambda-ui.Layout.Theme', function(newValue) {
  ...
  getURI() {
    ...
    return 'atom://awspilot-lambda-ui'
  }
